				...
				<div class="row">
					<div class="col-12 grid-margin stretch-card" style="height: 400px">
						<div class="card">
							...
							<input type="hidden" name="r_no" value="${notice.getR_no()}">
								<div class="row-lg-12" id="boardBox">
									<table class="table" id="article-table"
										style="margin-top: 2rem;">
										<tbody>
											<tr>
												<td class="title col-3"><input type="text"
													class="form-control form-control-lg"
													id="exampleInputEmail1" readonly
													value="${report.getTitle()}"></td>
												<td class="writer col-2"><input type="text"
													class="form-control form-control-lg"
													id="exampleInputEmail1" readonly
													value="${report.getWriter()}"></td>
												<td class="date col-2"><input type="text"
													class="form-control form-control-lg"
													id="exampleInputEmail1" readonly
											...
											<tr>
												<td colspan=3 class="title col-12"><textarea
														class="form-control form-control-lg" id="content"
														style="height: 110px" readonly
									...
									<div class="mt-3 text-center" style="margin: 0.5rem auto">
										<ul
											...
											<li><input type="hidden" name="r_no"
												value="${report.getR_no()}">
												<button name="selectStatus" id="selectStatus" value="check"
													class="btn btn-block btn-gradient-primary btn-lg font-weight-medium auth-form-btn"
													style="width: 15rem; margin: 0 0.5rem;">신고처리</button></li>
											<li><input type="hidden" name="r_no"
												value="${report.getR_no()}">
												<button name="selectStatus" id="selectStatus" value="return"
													class="btn btn-block btn-gradient-primary btn-lg font-weight-medium auth-form-btn"
													style="width: 15rem; margin: 0 0.5rem;">신고반려</button></li>
										</ul>
									</div>
								</div>
						</form>

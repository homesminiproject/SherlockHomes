					...
					<div class="col-lg-4 mx-auto">
						<div class="auth-form-light text-left p-5">
							<div class="brand-logo text-center">
								<a href="/SherlockHomes/index.jsp"><img
									src="/SherlockHomes/images/HOMES.png">
									<h1 id="logoText">셜록HOMES</h1>
									<h4 id="logoText">―― 전세사기 없이 청정한 ――</h4></a> <br>
								<h3>공인중개사 회원가입</h3>
							</div>
							<form action="agentmembershipUser.do8" method="post"
								name="usersMember">
								<div class="form-group">
									<div class="input-group">
										<input type="email" class="form-control" id="id" name="id"
											onkeyup="idCheckFunction()" placeholder="아이디(이메일형식)" required>
								...
								<div class="form-group">
									<input type="password" class="form-control" id="pw1" name="pw1"
										placeholder="비밀번호（８자 이상 영문,숫자,특수문자 포함）" required>
								</div>
								<div class="form-group">
									<input type="password" class="form-control" id="pw2" name="pw2"
										onkeyup="passwordCheckFunction()"
										placeholder="비밀번호 확인（８자 이상 특수문자 포함）" required> <span
										id="pwText"></span>
								</div>
								<div class="form-group">
									<input type="text" class="form-control" id="rep_name"
										name="rep_name" placeholder="대표자명" required>
								</div>
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="detailaddress" name="detailaddress" placeholder="상세주소">
								...
								<div class="phone-input-group">
									<input type="tel" class="form-control phone-input" id="phone1"
										name="phone1" pattern="[0-9]{3}" maxlength="3"
										oninput="this.value = this.value.replace(/[^0-9]/g, '');"
										required> <span class="dash">－</span> <input
										type="tel" class="form-control phone-input" id="phone2"
										name="phone2" pattern="[0-9]{4}" maxlength="4"
										oninput="this.value = this.value.replace(/[^0-9]/g, '');"
										required> <span class="dash">-</span> <input
										type="tel" class="form-control phone-input" id="phone3"
										name="phone3" pattern="[0-9]{4}" maxlength="4"
										oninput="this.value = this.value.replace(/[^0-9]/g, '');"
										required>
								</div>
								<div class="form-group">
									<input type="text" class="form-control" id="agency_name"
										name="agency_name" placeholder="상호명" required>
								</div>
								<div class="form-group">
									<input type="text" class="form-control" id="license_number"
										name="license_number" placeholder="공인중개사등록번호(-제외)"
										pattern="[0-9]{14}" maxlength="14"
										oninput="this.value = this.value.replace(/[^0-9]/g, '');"
										required>
								</div>
								<div class="form-group">
									<input type="text" class="form-control" id="regi_number"
										name="regi_number" placeholder="사업자등록번호(-제외)"
										pattern="[0-9]{14}" maxlength="14"
										oninput="this.value = this.value.replace(/[^0-9]/g, '');"
										required>
								</div>
								<div class="form-group form-check">
									<input type="checkbox" class="form-check-input" id="agree2"
										onchange="toggleSubmitButton()"> <label
										class="form-check-label text-muted" for="agree2">이용약관
										및 개인정보 수집/이용동의</label>
								</div>
								<button type="submit"
									class="btn btn-primary btn-block btn-signup" id="submitBtn"

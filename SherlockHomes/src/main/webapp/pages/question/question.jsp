  ...
  <script>
    $(document).ready(function() {
        ...
        $('form').submit(function(event) {
            ...
            $.ajax({
                type: 'POST', // 요청 방식
                url: 'getListQuestion.do6', // 요청 URL
                data: { // 전송할 데이터
...
<div class="row" style="padding-left: 20px">
        <div class="card card-margin search-form">
            <div class="card-body p-0">
                <form action="SearchQuestion.do6" method="post">
                    <div class="row">
                        <div class="col-12">
...
// QuestionDAO를 이용하여 공지사항 리스트 가져오기
    ...
    <div class="row-lg-12" id="boardBox">
        <table class="table" id="article-table">
            ...
            <tr>
                ...
                <td><a href="getQuestion.do6?q_no=<%= question.getQ_no() %>"><%= question.getQ_title() %></a></td>
    ...
    <div class="row" style="margin:0 auto;">
        <nav id="pagination" aria-label="Page navigation">
            <ul class="pagination justify-content-center">
                <li class="page-item">
                    <a class="page-link" href="listQuestion.do6?page=<%= prevPage %>" aria-label="Previous">
                        <span aria-hidden="true">&laquo;</span>
                    </a>
                </li>
                <% for (int i = 1; i <= totalPages; i++) { %>
                    <li class="page-item <%= i == currentPage ? "active" : "" %>">
                        <a class="page-link" href="listQuestion.do6?page=<%= i %>"><%= i %></a>
                    </li>
                <% } %>
                <li class="page-item">
                    <a class="page-link" href="listQuestion.do6?page=<%= nextPage %>" aria-label="Next">

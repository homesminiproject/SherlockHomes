								...
								<div class="row-lg-12" id="boardBox">
									<table class="table" id="article-table"
										...
										<tbody>
											...
											<tr>
												<td colspan="4" class="content col-12"><input
													type="text" class="form-control form-control-lg"
													id="content" name="content"
													value="${question.getContent()}" readonly></td>
											</tr>
										</tbody>
									</table>
								</div>
							...
							<div class="card">
								<div class="row-lg-12" id="boardBox">
									<table class="table" id="article-table"
										...
										<tbody>
											<tr>
												<td class="hashtag col-10"><textarea
														class="form-control form-control-lg" id="reply"
														name="reply" placeholder="내용" style="height: 10rem;">${question.reply()}</textarea></td>
											</tr>
										</tbody>
									</table>
								</div>

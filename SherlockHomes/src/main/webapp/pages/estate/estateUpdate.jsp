...
<script>
					    ...
					    function displayImage(imageUrl) {
					        ...
					        imgElement.alt = "이미지";
					        imgElement.style.width = "90%"; // 이미지 너비 설정
					        imgElement.style.height = "90%"; // 이미지 높이 설정
					        imgElement.style.margin = "1rem auto"; // 이미지 높이 설정
				...
				<table class="table" id="article-table" style="margin-top:2rem;">
									<tbody>
										...
										<tr>
											...
											<td class="hashtag col-4">
											<input type="text" class="form-control form-control-lg"
											id="area" name="area" value="${estate.getArea() }" style="width:200px; display:inline-block;"><h6 style="display:inline-block;">&nbsp;&nbsp;㎡</h6>
											</td>
										</tr>
										<tr>

...
<head>
  ...
  <!-- endinject -->
  <link rel="shortcut icon" href="/SherlockHomes/images/favicon.png" />
</head>
          ...
          <div class="col-lg-7 mx-auto text-white">
            ...
            <div class="row mt-5">
              <div class="col-12 text-center mt-xl-2">
                <a class="text-white font-weight-medium" href="/SherlockHomes/index.html">돌아가기</a>
              </div>
            </div>
            <div class="row mt-5">

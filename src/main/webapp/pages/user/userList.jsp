    ...
    <div class="row-lg-12" id="boardBox">
        <table class="table" id="article-table">
            ...
            <tr>
                ...
                <th class="created-at col-1"><a>성별</a></th>
...
<!-- 내용 -->            
            ...
            <tr>
                ...
                <td class="title"><a>aaaa</a></td>
                <td class="user-id">김자바</td>
                <td class="title"><a>서울시 강남구</a></td>
                <td class="created-at"><time>2024-03-13</time></td>
                <td class="created-at"><time>1999-01-01</time></td>
                <td class="created-at">남자</td>
                <td class="created-at">
                <a href="http://localhost:8080/SherlockHomes/pages/user/userUpdate.jsp"><i class="mdi mdi-pencil menu-icon"></i></a>
                 | 
                <a href="#"><i class="mdi mdi-delete-empty menu-icon"></i></a>
                </td>
            </tr>
            <tr>
            	<td class="hashtag">2222</td>
                <td class="title"><a>bbb</a></td>
                <td class="user-id">홍길동</td>
                <td class="title"><a>서울시 강서구</a></td>
                <td class="created-at"><time>2024-03-13</time></td>
                <td class="created-at"><time>1999-01-01</time></td>
                <td class="created-at">여자</td>
                <td class="created-at">
                <a href="http://localhost:8080/SherlockHomes/pages/user/userUpdate.jsp"><i class="mdi mdi-pencil menu-icon"></i></a>
                 | 
                <a href="#"><i class="mdi mdi-delete-empty menu-icon"></i></a>

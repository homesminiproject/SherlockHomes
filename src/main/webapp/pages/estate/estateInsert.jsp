		...
		<div class="main-panel">
			<div class="content-wrapper">
				...
				<form id="estateForm" action="InsertEstate.do4" method="post"
					...
					<div class="row">
						<!-- 왼쪽위박스 / photo -->
						<div class="col-5 grid-margin stretch-card" style="height: 350px">
							<div class="card">
						...
						<!-- 오른쪽위박스 / content -->
						<div class="col-7 grid-margin stretch-card" style="height: 350px">
							<div class="card">
					...
					<div class="row">
						<!-- 왼쪽아래박스 / 수정 가능한 부분 -->
						<div class="col-5 grid-margin stretch-card" style="height: 500px;">
							<div class="card">
										...
										<tbody>
											...
											<tr>
												...
												<td class="hashtag col-4"><textarea
														style="height: 120px" class="form-control form-control-lg"
				...
				<div class="mt-3" style="margin: 0.5rem auto">
					<button type="submit" id="uploadButton"
						class="btn btn-block btn-gradient-primary btn-lg font-weight-medium auth-form-btn">등록하기</button>
				</div>
				</form>

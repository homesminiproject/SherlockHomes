...
<%
    ...
    List<NoticeDTO> noticeList = noticeDAO.getNoticePage((currentPage - 1) * pageSize, pageSize);

    // 총 공지사항 개수 가져오기
    int totalNotices = noticeDAO.getTotalRecords();
							...
							<div class="row" style="margin: 1rem auto;">
								<nav id="pagination" aria-label="Page navigation">
									<ul class="pagination justify-content-center">
										<li class="page-item">
                    <a class="page-link" href="notice.jsp?page=<%= prevPage %>" aria-label="Previous">
                        <span aria-hidden="true">&laquo;</span>
                    </a>
                </li>
                <% for (int i = 1; i <= totalPages; i++) { %>
                    <li class="page-item <%= i == currentPage ? "active" : "" %>">
                        <a class="page-link" href="notice.jsp?page=<%= i %>"><%= i %></a>
                    </li>
                <% } %>
                <li class="page-item">
                    <a class="page-link" href="notice.jsp?page=<%= nextPage %>" aria-label="Next">
